...
public class Conversor {
    ...
    public static double converterTempo(double valor, String unidadeOrigem, String unidadeDestino) {
        ...
        switch (unidadeOrigem) {
            case "s" -> segundos = valor;
            case "min" -> segundos = valor * 60;
            case "h" -> segundos = valor * 3600;
            case "d" -> segundos = valor * 86400;
    ...
    public static double converterVelocidade(double valor, String unidadeOrigem, String unidadeDestino) {
        ...
        switch (unidadeOrigem) {
            case "m" -> metrosPorSegundo = valor;
            case "km" -> metrosPorSegundo = valor / 3.6;
            case "mi" -> metrosPorSegundo = valor * 0.44704;
            case "kn" -> metrosPorSegundo = valor * 0.514444;
            default -> throw new UnidadeInvalidaException("Unidade de origem inválida: " + unidadeOrigem);
        }
        ...
        switch (unidadeDestino) {
            ...
            case "kn" -> {
                return metrosPorSegundo / 0.514444;
            }
            default -> throw new UnidadeInvalidaException("Unidade de destino inválida: " + unidadeDestino);
        }
    }
    ...
    public static double converterArea(double valor, String unidadeOrigem, String unidadeDestino) {
        ...
        switch (unidadeOrigem) {
            case "m" -> metrosQuadrados = valor;
            case "km" -> metrosQuadrados = valor * 1_000_000;
            case "ha" -> metrosQuadrados = valor * 10_000;
            case "ac" -> metrosQuadrados = valor * 4046.86;
            default -> throw new UnidadeInvalidaException("Unidade de origem inválida: " + unidadeOrigem);
        }
        ...
        switch (unidadeDestino) {
            ...
            case "km" -> {
                return metrosQuadrados / 1_000_000;
            }
            case "ha" -> {
                return metrosQuadrados / 10_000;
            }
            case "ac" -> {
